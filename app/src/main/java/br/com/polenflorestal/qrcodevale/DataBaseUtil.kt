...
object DataBaseUtil {
    ...
    fun criaDB(){
        val SCRIPT_DATABASE_CREATE = arrayOf(
            ...
            "INSERT INTO [Arvore]([codigo], [tipo], [local], [parcela], [linha], [bloco], [arvore_pos], [codigo_geno], [genitor_fem], [genitor_mas], [data_plantio], [ult_medicao], [dap], [altura], [vol], [procedencia], [historico], [especie_comp], [coordenadas]) VALUES('P2089B338A1', 1, 'Nova Lima/MG', 2089, 14, 338, 39, 'Euplassa semicostata ', '(E. dunnii x E. grandis) x (E. urophylla 2)', 'Desconhecido (pol. Livre)', '8/27/2011 12:00:00 AM', '5/21/2019 12:00:00 AM', 21, 23, 0.19, 'Nova Lima/MG', 'Este indivíduo foi resgatado de uma área minerada no ano de 2016. Utilizando-se técnicas de enxertia, propágulos foram colhidos da árvore matriz e enxertados em porta-enxertos da mesma espécie, em parceria com a UFV.\nApós 6 meses de cuidados em viveiro, a muda enxertada foi reintroduzida em área próxima ao local onde foi resgatada, garantindo a permanência do indivíduo em seu local de ocorrência natural, e permitindo a perpetuação dos genes desta árvore na região.', '', '20°04''55.6\"S 43°57''06.0\"W');",
